  ...
  public void nonGraphicsGame() {
    ...
    while (this.counter != 10 && !gagner) {
      ...
      if (joueurEstHumain == true) {
        ...
        BotIntelligent botIntelligent = new BotIntelligent(this.proposition, this.counter, indice);
        if (this.counter == 0) {
          botIntelligent.setProposition();
        } else {
          botIntelligent.setProposition(indice);
        }
